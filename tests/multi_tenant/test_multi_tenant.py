...
def test_login(
    ...
    with fence_client_app.test_client() as fence_client_client:
        # Part 1.
        redirect_url_quote = urllib.parse.quote('/login/fence/login')
    ...
    with app.test_client() as client:
        ...
        authorize_params = urllib.parse.parse_qs(
            urllib.parse.urlparse(response_login_fence.location).query
        )
